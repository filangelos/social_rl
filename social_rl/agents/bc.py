...
# ==============================================================================
"""Simple behavioural cloning agent."""
...
class BCNetwork(hk.Module):
  ...
  def __init__(self, num_actions: int, name: Optional[str] = None) -> None:
    ...
    Args:
      action_spec: The number of available discrete actions.
    """
...
class BCAgent(parts.Agent):
  ...
  def actor_step(
    ...
    """
    policy_logits = self._network.apply(
  ...
  #   policy_logits = self._network.apply(params, transition.s_tm1['pixels'])
